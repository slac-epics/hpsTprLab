...
epicsEnvSet("IOC_PV", "SIOC:B84:TS63")
epicsEnvSet("IOC",    "sioc-b84-ts63")
...
dbLoadRecords("db/evTSTest.db", "user=khkim,N=1000")
dbLoadRecords("db/evTSTest.db", "user=khkim,N=1001")
dbLoadRecords("db/evTSTest.db", "user=khkim,N=1002")
...
tprTriggerAsynDriverConfigure("trig0", "PCIeSlave:/dev/tprb")
